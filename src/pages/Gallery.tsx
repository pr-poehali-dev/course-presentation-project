...
const Gallery = () => {
  ...
  const images = [
    {
      id: 1,
      url: 'https://cdn.poehali.dev/files/photo_1_2025-12-27_23-53-49.jpg',
      title: 'Графичные пайетки',
      category: 'Декоративные ткани',
    },
    {
      id: 2,
      url: 'https://cdn.poehali.dev/files/photo_2_2025-12-27_23-53-49.jpg',
      title: 'Элегантное кружево',
      category: 'Кружевные ткани',
    },
    {
      id: 3,
      url: 'https://cdn.poehali.dev/files/photo_3_2025-12-27_23-53-49.jpg',
      title: 'Переливающиеся пайетки',
      category: 'Декоративные ткани',
    },
    {
      id: 4,
      url: 'https://cdn.poehali.dev/files/photo_5_2025-12-27_23-53-49.jpg',
      title: 'Серебряное кружево',
      category: 'Кружевные ткани',
    },
    {
      id: 5,
      url: 'https://cdn.poehali.dev/files/photo_6_2025-12-27_23-53-49.jpg',
      title: 'Изысканная вышивка',
      category: 'Декоративные ткани',
    },
    {
      id: 6,
      url: 'https://cdn.poehali.dev/files/photo_4_2025-12-27_23-53-49.jpg',
      title: 'Утонченное кружево',
      category: 'Кружевные ткани',
    },
  ];
